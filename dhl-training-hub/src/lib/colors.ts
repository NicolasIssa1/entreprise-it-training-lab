 ...
 */
export type ColorSlug = "sky" | "blue" | "cyan" | "indigo" | "rose" | "emerald" | "violet" | "amber" | "teal";
...
const COLOR_STYLES: Record<ColorSlug, ColorStyle> = {
  ...
  teal: {
    badge: "bg-teal-50 text-teal-700 ring-1 ring-inset ring-teal-200 dark:bg-teal-950/70 dark:text-teal-300 dark:ring-teal-900",
    dot: "bg-teal-500",
    text: "text-teal-600 dark:text-teal-400",
    chip: "bg-teal-100 text-teal-600 dark:bg-teal-950 dark:text-teal-300",
    gradient: "from-teal-500 to-teal-600",
    border: "hover:border-teal-300 dark:hover:border-teal-800/70",
    shadow: "hover:shadow-teal-900/[0.08]",
    bar: "bg-teal-500",
  },
};
