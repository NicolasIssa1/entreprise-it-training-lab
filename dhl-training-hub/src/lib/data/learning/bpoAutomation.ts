...
export const bpoAutomationTopics: LearningTopic[] = [
  ...
  // ---------------------------------------------------------------------
  {
    ...
    relatedTopicIds: ["automation-opportunity-assessment", "triggers-and-actions", "business-automation", "enterprise-automation-overview"],
  ...
  },
  {
    ...
    relatedTopicIds: ["system-integration", "automation-governance-and-ownership", "common-power-automate-failure-patterns", "sharepoint-fundamentals", "outlook-email-workflow-automation"],
  ...
  },
  {
    ...
    relatedTopicIds: ["loops-apply-to-each", "common-power-automate-failure-patterns", "connectors-and-data-sources", "power-bi-fundamentals"],
